var version = "1.2.1";
    ...
    //red color, green color, blue color, alpha, emision intensity, triangle a index, triangle b index
    var faces = [
        {r:255,g:128,b:0  ,a:1,emision:0,ind:0,inde:1},
        {r:0  ,g:255,b:0  ,a:1,emision:0,ind:2,inde:3},
        {r:0  ,g:128,b:255,a:1,emision:0,ind:4,inde:5},
        {r:0  ,g:0  ,b:255,a:1,emision:0,ind:6,inde:7},
        {r:64 ,g:128,b:162,a:1,emision:0,ind:8,inde:9},
        {r:255,g:0  ,b:0  ,a:1,emision:0,ind:10,inde:11}
    ]
    ...
    */
    ...
    function GetFaceShaderColor(index, ambientLightIntensity, lightIntensity, lightR, lightG, lightB, influences) {
        ...
        r = Lerp(parseInt(r), faces[index].r, faces[index].emision);
        g = Lerp(parseInt(g), faces[index].g, faces[index].emision);
        b = Lerp(parseInt(b), faces[index].b, faces[index].emision);
        r = Clamp(r, 0, 255);
        g = Clamp(g, 0, 255);
        b = Clamp(b, 0, 255);
    ...
    function DrawMesh() {
        ...
        if (drawmode == "face") {
            ...
            for (var i = 0; i < faces.length; i++) {
                ...
                if (avrz < camera.viewdistance) {
                    ...
                    ctx.closePath();
                    ctx.globalAlpha = faces[depthIndex[i].i].a;
            ...
            for (var i = 0; i < faces.length; i++) {
                ...
                lightArray[i] = (lightInFaceA + lightInFaceB) / 2;
        ...
        if (drawmode == "face") {
            ...
            for (var i = 0; i < depthIndex.length; i++) {
                ...
                ctx.fillText('∎', 5, 190 + pos * 15);
                ctx.fillStyle = (customBG ? "#000000" : "#ffffff");
                ctx.fillText('face [' + depthIndex[i].i + '] depth: ' + (depthIndex[i].d / 100).toFixed(2) + ", light power; " + lightArray[i].toFixed(2), 20, 190 + pos * 15);
                pos++;
            }
        }
        else if (drawmode == "depth") {
